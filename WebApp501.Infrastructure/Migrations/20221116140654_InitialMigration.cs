    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlcoholsCocktails", x => new { x.AlcoholId, x.CocktailId });
                    table.ForeignKey(
                        name: "FK_AlcoholsCocktails_Alcohols_AlcoholId",
                        column: x => x.AlcoholId,
                        principalTable: "Alcohols",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlcoholsCocktails_Cocktails_CocktailId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "30342ffd-ffd8-4e66-9348-da6a2068856e", 0, "9ad90eea-f6e6-4d2d-b2ec-7f6cb056749b", "doomar@abv.bg", false, false, null, "DOOMAR@ABV.BG", "D00M3R", "AQAAAAEAACcQAAAAECJb8N+uEyRXhJ51sgVQKza9uM0vOMr9YIHu75nX5tpj0zNwEMW8oDhtXrBhKk+PPg==", null, false, "567be458-be98-4c03-bc86-4cdb6fb5f14f", false, "d00m3r" },
                    { "726719c4-8995-4426-9c00-1cb0831621d4", 0, "f0fc2768-bdb7-40b6-8d19-4604f97f5839", "dbyalkov@abv.bg", false, false, null, "DBYALKOV@ABV.BG", "DBYALKOV", "AQAAAAEAACcQAAAAEBKx8gzJzZTFJvKz15p2wfXIfac+bSorNZRESZi29p4y8Q5lsIVxYa5bERczkl61Gg==", null, false, "11613833-e39f-48dc-b919-32a7b7beb483", false, "dbyalkov" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Cocktails",
                columns: new[] { "Id", "AlcoholId", "BartenderId", "GlassId", "ImageUrl", "IsDeleted", "Name", "Preparation", "Recipe" },
                values: new object[,]
                {
                    { 1, 1, 1, 1, "https://www.google.com/search?q=Cocktail+Gauguin&hl=en&sxsrf=ALiCzsYZijqseouEFjzKEYTw-66_8uzpsA%3A1668594209334&ei=Ibp0Y5P1E_GTxc8PpdmT8AI&ved=0ahUKEwjTifzovbL7AhXxSfEDHaXsBC4Q4dUDCA8&uact=5&oq=Cocktail+Gauguin&gs_lcp=&sclient=gws-wiz-serp", false, "Gauguin", "Place the crushed ice, rum, syrup and lemon juice in a blender and blend on low speed for 15 seconds. Strain the resulting mixture into an old fashioned glass and garnish with the cocktail cherry.", "3 parts crushed ice\r\n2 parts white rum\r\n2 tsp passion fruit syrup\r\n2 tsp lemon juice\r\n1 tsp lime juice\r\n1 cocktail cherry for decoration" },
